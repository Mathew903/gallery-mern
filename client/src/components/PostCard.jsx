...
export const PostCard = ({ post }) => {
    ...
    const handleDelete = (id) => {
        toast(t => (
            <div>
                <p className='text-white mb-3'>Do you want to delete? <strong>{id}</strong></p>
                <div>
                    <button className='bg-red-500 hover:bg-red-400 px-3 py-2 text-sm text-white rounded-sm mx-2' onClick={async () => {
                        await deletePost(id);
                        toast.dismiss(t.id);
                    }}>Delete</button>
