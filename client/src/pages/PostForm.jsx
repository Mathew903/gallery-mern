			...
			<div className='bg-zinc-800 p-10 shadow-md shadow-black'>
				...
				{({handleSubmit, setFieldValue, isSubmitting}) => (
					<Form onSubmit={handleSubmit}>
						...
						<label htmlFor="image" className='text-sm block font-bold text-gray-400'>
							Image
						</label>
						...
						<button 
							type='submit' 
							className='bg-indigo-600 hover:bg-indigo-500 px-4 py-2 rounded mt-4 text-white focus:outline-none disabled:bg-indigo-400'
